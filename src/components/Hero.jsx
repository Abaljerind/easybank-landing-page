...
const Hero = () => {
  return (
    <section className="flex flex-col-reverse pb-20 md:flex-row md:pb-4 lg:pb-8 xl:pb-24">
      {/* hero text */}
      ...
      {/* hero image */}
      <figure className="relative overflow-hidden md:h-screen md:w-full lg:max-w-2xl lg:overflow-hidden">
        <img
